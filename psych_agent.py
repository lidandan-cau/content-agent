...
PSYCH_CONCEPTS = """
以下是按主题分类的心理学概念库，AI 优先从对应当日主题方向中选取，
也可以选择库外但适合大众科普的概念，不局限于此列表。

【认知心理学 · 思维偏差与认知模式（35条）】
确认偏误、沉没成本谬误、达克效应、心理账户、锚定效应、
过度泛化、灾难化思维、非黑即白思维、归因偏差、认知失调、
可得性启发、框架效应、后见之明偏误、自我服务偏误、群体思维、
代表性启发、情绪性推理、心理滤镜、贴标签、个人化、
应该句式、读心术、预言自证、焦点效应、规划谬误、
乐观偏误、现状偏误、损失厌恶、决策疲劳、选择悖论、
认知负荷、思维反刍、心理模拟、具身认知、注意力偏差

【情绪心理学 · 情绪本质与调节（35条）】
情绪颗粒度、情绪压抑与替代性爆发、情感麻木、习得性无助、情绪传染、
次级情绪、认知重评、情绪化进食、积极情绪的拓展建构理论、心理免疫系统、
愤怒背后的一次情绪理论、羞耻感与内疚感的区别、悲伤的五阶段理论、
情绪性记忆、恐惧的习得与消退、焦虑的认知模型、正念与情绪觉察、
躯体化、情绪智力、自我同情、恐惧管理理论、情绪标签化、心理距离、
愉悦缺失感、应激反应与冻结反应、感激与幸福感的关系、
敬畏感的心理效应、无聊感的心理学、嫉妒与羡慕的区别、
内疚感的功能与代价、情绪调节的认知策略、情绪暴露疗法、
二次伤害与情感验证、情绪的进化功能、情绪粒化训练

【关系心理学 · 依恋沟通与边界（35条）】
安全型依恋、焦虑型依恋、回避型依恋、混乱型依恋、投射性认同、
共情疲劳、情感勒索、煤气灯效应、课题分离、非暴力沟通、
心理边界的四种类型、爱的五种语言、斯坦伯格爱情三角理论、
戈特曼四骑士（批评/蔑视/防御/筑墙）、亲密恐惧、关系中的权力失衡、
自我暴露与信任建立、修复性对话、三角化、共依存关系、
关系成瘾、分离焦虑、拒绝敏感性、"你"信息 vs "我"信息、
倾听的层次、关系中的影响力 vs 控制、关系中的修复与道歉、
亲密感的维度、安全感信号、边界侵犯的识别、
镜像神经元与共情、过度付出的心理根源、情感忽视在关系中的表现、
自恋型人格在关系中的模式、关系中的权力博弈与操控识别

【发展心理学 · 童年经历与成长模式（30条）】
内在小孩、原生家庭的心理脚本、心理创伤的躯体化表现、
复杂性创伤、修复性体验、重新养育自己、
埃里克森八阶段心理社会发展、皮亚杰认知发展理论、
维果茨基最近发展区、道德发展理论、自我同一性发展、
创伤后成长、心理弹性的形成、内化的批评性声音、
童年逆境经历的长期影响、情感忽视的隐形伤害、
过度保护养育的心理影响、三种养育风格（权威/专制/放任）、
代际创伤传递、自我概念的形成、羞耻感的童年起源、
中年危机的心理学解读、身份认同危机、心理成熟度的标志、
晚年心理：回顾整合 vs 绝望、丧失与哀伤的发展视角、
心理年龄与实际年龄的差异、人生转折点的心理应对、
依恋的形成窗口期、不安全依恋的代际传递

【行为心理学 · 习惯动机与行为改变（30条）】
习惯回路（触发-行为-奖励）、拖延与完美主义的关系、
自我效能感、正强化与负强化、惩罚的心理副作用、
行为激活疗法、间歇强化的成瘾性、内在动机 vs 外在动机、
暴露疗法、系统脱敏、操作性条件作用、
经典条件作用与情绪反应、自我调节失败的机制、
意志力的有限资源模型、执行意图、环境设计对行为的影响、
社会学习理论与观察学习、认知行为治疗的核心逻辑、
行为回避与问题维持循环、目标设定理论、微习惯策略、
恐惧与回避的维持循环、自我监控的效果、
改变阶段理论（前意图/意图/准备/行动/维持）、
行为的功能分析、强迫行为的维持机制、
奖励延迟与冲动控制、行为改变的动机访谈技术、
认知行为的暴露与反应预防、习惯叠加策略

【积极心理学 · 幸福感韧性与心流（30条）】
心流体验（Csikszentmihalyi）、心理韧性的五要素、感恩练习的神经机制、
PERMA模型、自我决定理论（自主/胜任/联结）、
成长型思维 vs 固定型思维、意义感与幸福感的区别、
主观幸福感的三要素、享乐适应、幸福的设定点理论、
心理资本、自我实现与高峰体验、心理福祉六维度模型、
习得性乐观、品格优势识别、心理宽恕的科学、
敬畏感与幸福、社会连接与长寿的关系、
正念冥想的神经可塑性效应、利他行为的心理收益、
意义疗法（Frankl的存在主义心理学）、创伤后成长的五个领域、
积极重评策略、幽默感的心理功能、好奇心与探索动机、
心理资源的建构与储备、自我接纳 vs 自我提升的张力、
时间观与幸福感的关系、心理安全感的建立、
目的感对健康的影响
"""
...
可参考的心理学概念库（优先从对应主题方向选取；也可选择库外适合大众的概念）：
{PSYCH_CONCEPTS}

选概念的标准：
- 优先选择有真实生活场景对应的概念（读者能在日常里认出来）
- 避免过于学术或需要大量背景知识才能理解的概念
- 同一个概念不要在短期内重复出现
